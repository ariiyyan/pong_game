...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\arrar\Desktop\Python practice\pong_game'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\arrar\Desktop\Python practice\pong_game\Scripts\deactivate.nu'
